...
echo "<script>alert(' Please Check Your Phone To Complete Transaction')</script>";
...
<html lang="en">
  ...
  <body>
    ...
    <div class="success">
      <h2 style ="text-align:center; padding:1em;"> Please wait for the transaction to be processed </h2>
