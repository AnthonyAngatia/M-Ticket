    ...
    <div class="super_container">
        ...
        <center>
            <div class="cart_positioning" style="display:inline-flex; ">
                ...
                <div class="button extra_1_button" style="width:200px !important;"><a href="browse.php">continue
                        shopping</a></div>
            </div>
        </center>
                ...
                <div class="row cart_extra">
                    ...
                    <div class="col-lg-6" style="">
                        <div class="cart_coupon">
                            ...
                            <form action="#"
                                ...
                                <input type="text" class="cart_coupon_input" placeholder="Enter points for discount"
                                    required="required">
                    ...
                    <div class="col-lg-5 offset-lg-1">
                        <div class="cart_total">
                            ...
                            <button class="cart_total_button"><a href="checkout.php" style="color:black;">proceed to
                                    checkout</a></button>
                        </div>
                    </div>
                </div>
