...
<body>
    ...
    <div class="super_container">
        ...
        <div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
            ...
            <div class="search">
                <form action="#">
                    <input type="search" class="search_input menu_mm" required="required" placeholder="Event name*"
                        aria-label="Search">
                    <button type="submit" class="newsletter_button"
                        style="width: 80px !important; height: 42px !important;">search</button>
                </form>
            </div>
            <nav class="menu_nav">
                <ul class="menu_mm">
        ...
        <center>
            <div class="button extra_1_button"
                style="padding-right: 5px !important; padding-left: 5px !important; width: 150px !important;"><a
                    href="index.html"> see more events </a></div>
        </center>
        <br>
        <br>
        ...
        <div id="float1">
            ...
            <br>
            <p>
                M-ticket is a platform for live experiences that allows event organisers to create their events and
                avails tickets for those particular events to any interested parties.
            </p>
            <br>
        </div>
        <br>
        ...
        <div class="newsletter" style="margin-bottom: 20px;">
            <div class="newsletter_content">
                ...
                <div class="container">
                    ...
                    <div class="newsletter_text" style="text-align: center;">Sign up to get our newsletter for all the
                        latest updates and details on upcoming events.</div>
