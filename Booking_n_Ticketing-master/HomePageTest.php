...
<body>
        ...
        <div class="header_inner d-flex flex-row align-items-center justify-content-start">
            ...
            <div class="header_content ml-auto">
                <div class="shopping">
                    ...
                    <a href="#">
                        <div class="cart">
                            <img src="/Assets/cart3.png" width="30" height="30" alt="">
    ...
    <div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
        ...
        <div class="search">
            <form action="#">
                ...
                <button type="submit" class="newsletter_button" style="width: 80px !important;">search</button>
            </form>
            ...
            <ul class="menu_mm">
                ...
                <li class="menu_mm"><a href="#">
                        <div class="avatar">account
                            <img src="/Assets/account1.png" width="30" height="30" alt="">
                        </div>
                    </a></li>
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="/Assets/festival1.jpg" class="d-block w-100" alt="...">
                ...
                <div class="carousel-item">
                    <img src="/Assets/event2.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                ...
                <div class="carousel-item">
                    <img src="/Assets/concert5.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
    ...
    <div class="card-deck">
        <div class="card">
            ...
            $link = connect();
            $sql = "SELECT Event_name, Event_description, Event_caption FROM event_tbl LIMIT 1";
            $result = mysqli_query($link, $sql);
            if (mysqli_num_rows($result) > 0) {
                while ($row = $result->fetch_assoc()) {
                    $image = ($row['Event_caption']);
                    /**Retrieved image in binary */
                    echo '<img src= "data:image/jpeg;base64,' . base64_encode($image) . '"  height="420" width = "300" class="card-img-top" > ' . "<br>";
                }
            }
            ?>
            <!--<img src="/Assets/poster6.jpg" class="card-img-top" height="420"  alt="...1">-->
            <div class="card-body">
        ...
        <div class="card">
            <img src="/Assets/poster7.jpg" class="card-img-top" height="420" alt="...2">
            <div class="card-body">
                <h5 class="card-title">Card title</h5>
        ...
        <div class="card">
            <img src="/Assets/poster9.jpg" class="card-img-top" height="420" alt="...3">
            <div class="card-body">
                <h5 class="card-title">Card title</h5>
        ...
        <div class="card">
            <img src="/Assets/poster3.jpg" class="card-img-top" height="420" alt="...4">
            <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
                <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
    ...
    <div class="card-deck">
        <div class="card">
            <img src="/Assets/poster4.jpg" class="card-img-top" height="420" alt="...">
            <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
                <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
        ...
        <div class="card">
            <img src="/Assets/poster5.png" class="card-img-top" height="420" alt="...">
            <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
                <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
        ...
        <div class="card">
            <img src="/Assets/poster8.jpg" class="card-img-top" height="420" alt="...">
            <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
                <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
        ...
        <div class="card">
            <img src="/Assets/poster9.jpg" class="card-img-top" height="420" alt="...">
            <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
                <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
    ...
    <div class="card-deck">
        <div class="card">
            <div class="card-body" style="text-align: center !important;">
                ...
                <img src="/Assets/reward2.jpg" class="card-img-top" height="250" alt="...">
                <br><br>
        ...
        <div class="card">
            <div class="card-body" style="text-align: center !important;">
                ...
                <img src="/Assets/wallet.jpg" class="card-img-top" height="250" alt="...">
                <br><br>
        ...
        <div class="card">
            <div class="card-body" style="text-align: center !important;">
                ...
                <img src="/Assets/ticket2.jpg" class="card-img-top" height="250" alt="...">
                <br><br>
